                  ...
                  {candidatesForConstituency.map((candidate, index) => (
                    <tr key={`${candidate.name}-${index}`}>
                      ...
                      <td>
                        {candidate.affidavit ? (
                          <a
                            href={buildAssetUrl(candidate.affidavit, candidate.name, 'হলফনামা')}
                            target="_blank"
                            rel="noopener"
                      ...
                      <td>
                        {candidate.expense ? (
                          <a
                            href={buildAssetUrl(candidate.expense, candidate.name, 'নির্বাচনী ব্যয় ও ব্যক্তিগত সম্পদের বিবরণী')}
                            target="_blank"
                            rel="noopener"
                            referrerPolicy="origin"
                            className="btn-download"
                      ...
                      <td>
                        {candidate.tax ? (
                          <a
                            href={buildAssetUrl(candidate.tax, candidate.name, 'আয়কর রিটার্ন')}
                            target="_blank"
                            rel="noopener"
                            referrerPolicy="origin"
                            className="btn-download"
